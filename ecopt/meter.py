...
class Observation:
    ...
    def __init__(self, train_energy: float, train_carbon: float,
                 evaluate_energy: float, evaluate_carbon: float,
                 utility: float, num_samples: int, hyperparams: dict):
        """Construct a new observation, provided energy metrics in Wh and
        carbon metrics in kg."""
...
class Meter:
    ...
    def __call__(self, model: Model) -> Observation:
        ...
        return Observation(
            ...
            utility, num_samples, hyperparams
        )
